...
DROP DATABASE IF EXISTS production_ptsdb;
CREATE DATABASE production_ptsdb;

-- --------------------------------------------------------

CREATE OR REPLACE TABLE production_ptsdb.organization_profile (
...
CREATE OR REPLACE TABLE production_ptsdb.user_profile (
...
CREATE OR REPLACE TABLE  production_ptsdb.user_goals (
...
CREATE OR REPLACE TABLE production_ptsdb.user_notes (
    ...
    CONSTRAINT fk_user_notes_user_id
      FOREIGN KEY (user_id)
      REFERENCES production_ptsdb.user_profile (user_id)
      ON DELETE RESTRICT
      ON UPDATE RESTRICT
);
...
CREATE OR REPLACE TABLE production_ptsdb.tasks (
...
CREATE OR REPLACE TABLE production_ptsdb.task_dependencies (
...
CREATE OR REPLACE TABLE  production_ptsdb.user_task_goals (
    user_id INT UNSIGNED NOT NULL,
...
CREATE OR REPLACE TABLE production_ptsdb.user_schedule_item (
