...
static po::options_description addOptions()
{
	...
	options.add_options()
		...
		("mysql-dbname", po::value<std::string>()->default_value("test_ptsdb"), "The name of the database that contains the tables")
		("user-data-file", po::value<std::string>()->default_value("Testing/testData/userData.txt"), "File path including file name to user test data")
