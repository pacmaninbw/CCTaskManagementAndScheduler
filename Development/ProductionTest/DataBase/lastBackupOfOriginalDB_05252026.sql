...
--
-- Host: localhost:3306
-- Generation Time: May 25, 2026 at 01:57 PM
...
-- Procedures
--
DROP PROCEDURE IF EXISTS `EventLocationsForCompleter`$$
CREATE DEFINER=`pacman`@`localhost` PROCEDURE `EventLocationsForCompleter` (IN `IDUser` INT)   BEGIN
...
DROP PROCEDURE IF EXISTS `EventTitlesForCompleter`$$
CREATE DEFINER=`pacman`@`localhost` PROCEDURE `EventTitlesForCompleter` (IN `IDUser` INT)   BEGIN
...
DROP PROCEDURE IF EXISTS `ScheduleItemContentSelectionList`$$
CREATE DEFINER=`pacman`@`localhost` PROCEDURE `ScheduleItemContentSelectionList` (IN `Content` VARCHAR(128), IN `IDUser` INT)   BEGIN
...
-- Functions
--
DROP FUNCTION IF EXISTS `findUserIDKeyByFullName`$$
CREATE DEFINER=`pacman`@`localhost` FUNCTION `findUserIDKeyByFullName` (`LastName` VARCHAR(45), `FirstName` TINYTEXT, `MiddleInitial` TINYTEXT) RETURNS INT(11) DETERMINISTIC BEGIN

    SET @UserIDKey = 0$$

DROP FUNCTION IF EXISTS `findUserIDKeyByLoginName`$$
CREATE DEFINER=`pacman`@`localhost` FUNCTION `findUserIDKeyByLoginName` (`LoginName` VARCHAR(45)) RETURNS INT(11) DETERMINISTIC BEGIN

    SET @UserIDKey = 0$$

DROP FUNCTION IF EXISTS `isValidUserLoginAndPassword`$$
CREATE DEFINER=`pacman`@`localhost` FUNCTION `isValidUserLoginAndPassword` (`LoginName` VARCHAR(45), `HashedPassWord` TINYTEXT) RETURNS TINYINT(4) DETERMINISTIC BEGIN
...
CREATE TABLE IF NOT EXISTS `OrganizationProfile` (
  ...
  `PrimaryContactUser` int(10) UNSIGNED DEFAULT NULL,
  `SecondaryContactUser` int(10) UNSIGNED DEFAULT NULL,
  `Street_Address` varchar(256) DEFAULT NULL,
  `City_Address` varchar(64) DEFAULT NULL,
  `Postal_Code` varchar(32) DEFAULT NULL,
  `State_or_Province` varchar(256) DEFAULT NULL,
  `Nation` varchar(64) DEFAULT NULL,
  `CreatedTS` datetime NOT NULL,
  `LastUpdateTS` datetime NOT NULL,
  PRIMARY KEY (`OrganizationID`),
  UNIQUE KEY `OrgName_idx` (`Organization_Name`),
  KEY `fk_OrganizationProfile_PrimaryContact_idx` (`PrimaryContactUser`)
...
CREATE TABLE IF NOT EXISTS `Tasks` (
  ...
  `AsignedTo` int(10) UNSIGNED NOT NULL,
  ...
  `EstimatedEffortHours` int(10) UNSIGNED NOT NULL,
  `ActualEffortHours` double NOT NULL,
  `SchedulePriorityGroup` int(10) UNSIGNED NOT NULL,
  `PriorityInGroup` int(10) UNSIGNED NOT NULL,
  `Personal` tinyint(1) DEFAULT NULL,
  `DependencyCount` int(10) UNSIGNED DEFAULT NULL,
  `Dependencies` mediumtext DEFAULT NULL,
  `LastUpdateTS` datetime NOT NULL,
  PRIMARY KEY (`TaskID`,`CreatedBy`),
  UNIQUE KEY `TaskID_UNIQUE` (`TaskID`),
  KEY `fk_Tasks_CreatedBy_idx` (`CreatedBy`),
  KEY `fk_Tasks_AsignedTo_idx` (`AsignedTo`),
  KEY `Task_Description_idx` (`Description`),
  KEY `Task_LastUpdateTS_idx` (`LastUpdateTS` DESC),
  KEY `Task_SchedulePriorityGroup_idx` (`SchedulePriorityGroup`),
  KEY `Task_PriorityInGroup_idx` (`PriorityInGroup`),
  KEY `Task_Status_idx` (`Status`),
  KEY `Task_RequiredDelivery_idx` (`RequiredDelivery`),
  KEY `Task_ScheduledStart_idx` (`ScheduledStart`)
...
(1, 1, 1, 'Create a personal planner program that allows task mangement using QT and C++.', NULL, 3, 0, '2026-01-26 14:49:02', '2026-02-20', '2026-02-20', '2026-02-23', '2026-04-30', NULL, 1000, 500, 1, 1, 0, 27, '2;3;5;10;12;13;14;15;19;20;24;25;26;27;30;31;33;35;37;38;39;40;43;46;47;48;49;', '2026-04-07 11:24:31'),
(2, 1, 1, 'Add creation of notes in Database.', 1, 4, 0, '2026-01-26 15:18:38', '2026-02-28', '2026-02-28', NULL, '2026-02-28', '2026-03-14', 8, 8, 1, 3, 0, 0, NULL, '2026-03-14 14:40:10'),
(3, 1, 1, 'Add editing of note to update database.', 1, 4, 0, '2026-01-26 15:19:47', '2026-02-28', '2026-02-28', NULL, '2026-02-28', '2026-03-14', 4, 4, 1, 4, 0, 0, NULL, '2026-03-14 14:40:20'),
(4, 1, 1, 'Get toenails trimmed', NULL, 4, 0, '2026-01-26 15:21:21', '2026-02-07', '2026-02-07', NULL, '2026-02-07', '2026-02-21', 1, 0, 3, 1, 0, 0, NULL, '2026-02-21 22:14:07'),
(5, 1, 1, 'Connect goal creation and editing to database.', 1, 0, 0, '2026-01-26 15:23:03', '2026-04-04', '2026-04-04', NULL, '2026-04-04', NULL, 6, 0, 1, 6, 0, 0, NULL, '2026-04-18 11:39:17'),
(6, 1, 1, 'Implement task editing.', NULL, 4, 0, '2026-01-26 15:24:39', '2026-02-07', '2026-02-07', NULL, '2026-02-07', '2026-02-21', 8, 0, 1, 5, 0, 0, NULL, '2026-02-21 22:13:39'),
(7, 1, 1, 'Redisplay schedule after adding or editing a schedule item.', NULL, 4, 0, '2026-02-13 15:07:13', '2026-02-16', '2026-02-14', '2026-02-22', '2026-02-22', '2026-02-22', 4, 6, 1, 4, 0, 0, NULL, '2026-02-22 16:14:56'),
(8, 1, 1, 'Redisplay tasks after adding or editing a task.', NULL, 4, 0, '2026-02-13 15:08:37', '2026-02-17', '2026-02-16', NULL, '2026-02-17', '2026-02-22', 4, 0, 1, 3, 0, 0, NULL, '2026-02-22 16:14:27'),
(9, 1, 1, 'Sort tasks by group priority and priority.', NULL, 4, 0, '2026-02-13 15:11:09', '2026-02-15', '2026-02-13', '2026-02-21', '2026-02-16', '2026-02-21', 6, 4, 1, 3, 0, 0, NULL, '2026-02-21 22:12:22'),
(10, 1, 1, 'Implement editing of existing tasks', 1, 3, 0, '2026-02-13 15:12:44', '2026-04-04', '2026-04-04', '2026-02-21', '2026-04-04', NULL, 8, 24, 1, 10, 0, 0, NULL, '2026-04-18 11:38:36'),
(11, 1, 1, 'Implement editing of schedule.', NULL, 4, 0, '2026-02-13 15:13:49', '2026-02-19', '2026-02-18', NULL, '2026-02-19', '2026-02-21', 8, 0, 1, 5, 0, 0, NULL, '2026-02-21 22:24:39'),
(12, 1, 1, 'Finish the ability to edit tasks. Implement select parent task, add dependencies, display of dependencies.', 1, 3, 0, '2026-02-22 16:13:38', '2026-04-04', '2026-04-04', '2026-03-07', '2026-04-04', NULL, 16, 20, 1, 9, 0, 1, '44;', '2026-04-18 11:38:49'),
(13, 1, 1, 'Figure out how to use signals and slots to implement table view updates.', 0, 0, 0, '2026-02-22 16:18:48', '2026-03-06', '2026-03-06', NULL, '2026-03-06', NULL, 4, 1, 2, 5, 0, 0, NULL, '2026-03-20 13:13:24'),
(14, 1, 1, 'Clear selections after table edits.', 1, 4, 0, '2026-02-22 16:21:28', '2026-03-06', '2026-03-06', NULL, '2026-03-06', '2026-03-20', 4, 1, 2, 1, 0, 0, NULL, '2026-03-20 13:12:04'),
(15, 1, 1, 'Create Task View Table for select parent task', 1, 4, 0, '2026-02-23 14:46:41', '2026-02-28', '2026-02-28', '2026-03-06', '2026-02-28', '2026-03-14', 8, 8, 1, 11, 0, 0, NULL, '2026-03-14 14:41:43'),
(16, 1, 1, 'Create Requirement system to augment the planning system', NULL, 0, 0, '2026-02-23 14:50:03', '2026-05-31', '2026-04-30', NULL, '2026-05-31', NULL, 300, 0, 3, 1, 0, 0, NULL, '2026-02-23 14:50:03'),
(17, 1, 1, 'Implement user preferences in planner', NULL, 0, 0, '2026-02-23 14:52:01', '2026-03-04', '2026-03-01', NULL, '2026-03-04', NULL, 24, 0, 3, 1, 0, 0, NULL, '2026-03-06 15:04:31'),
(18, 1, 1, 'Find a Silver Sneakers program   ', NULL, 0, 0, '2026-02-25 12:47:09', '2026-03-06', '2026-03-06', NULL, '2026-03-06', NULL, 4, 0, 2, 4, 0, 0, NULL, '2026-03-20 13:13:13'),
(19, 1, 1, 'Add alternate methods of connecting to the database and logging in. Use environment variable and or command line flags.', 1, 3, 0, '2026-02-27 13:25:42', '2026-04-04', '2026-04-04', '2026-03-06', '2026-04-04', NULL, 16, 20, 1, 7, 0, 0, NULL, '2026-04-18 11:39:06'),
(20, 1, 1, 'Add the ability to repeat schedule items on a daily basis.', 1, 0, 0, '2026-02-27 13:29:45', '2026-03-06', '2026-03-06', NULL, '2026-03-06', NULL, 16, 0, 2, 2, 0, 0, NULL, '2026-03-20 13:12:36'),
(21, 1, 1, 'Add the ability to find an old schedule item and add it again to a new schedule', NULL, 0, 0, '2026-02-27 13:32:10', '2026-02-27', '2026-02-27', NULL, '2026-02-27', NULL, 16, 0, 3, 2, 0, 0, NULL, '2026-03-06 15:04:40'),
(22, 1, 1, 'Add the ability to reuse locations in the schedule.', NULL, 0, 0, '2026-02-27 13:33:22', '2026-02-27', '2026-02-27', NULL, '2026-02-27', NULL, 24, 0, 3, 3, 0, 0, NULL, '2026-03-06 15:04:51'),
(23, 1, 1, 'Freeze Chicken fillets', NULL, 4, 0, '2026-02-27 23:25:15', '2026-03-05', '2026-02-27', NULL, '2026-02-27', '2026-03-03', 1, 0.25, 1, 1, 0, 0, NULL, '2026-03-03 12:35:26'),
(24, 1, 1, 'Fix bug in scheduler where late appointments appear in the next day schedule.', 0, 4, 0, '2026-02-28 12:55:47', '2026-02-28', '2026-02-28', NULL, '2026-02-28', '2026-03-07', 8, 1.5, 1, 4, 0, 0, NULL, '2026-03-07 15:09:11'),
(25, 1, 1, 'Debug parent task id not being set in the database when the parent has been selected', 0, 4, 0, '2026-03-01 14:31:51', '2026-03-01', '2026-03-01', '2026-03-01', '2026-03-01', '2026-03-06', 2, 3, 1, 4, 0, 0, NULL, '2026-03-06 15:00:15'),
(26, 1, 1, 'Add production test database contents to unit/integration tests.2 ', 0, 0, 0, '2026-03-01 16:21:30', '2026-03-01', '2026-03-01', NULL, '2026-03-01', NULL, 2, 0, 3, 4, 0, 0, NULL, '2026-03-06 15:05:02'),
(27, 1, 1, 'Schedule date is based on GMT rather than local time, this causes some schedule items to appear on the wrong date.', 0, 4, 0, '2026-03-04 03:10:24', '2026-03-03', '2026-03-03', NULL, '2026-03-03', '2026-03-07', 2, 1.5, 1, 2, 0, 0, NULL, '2026-03-07 15:08:44'),
(28, 1, 1, 'Get a replacement blood pressure monitor', NULL, 4, 0, '2026-03-04 12:40:26', '2026-03-04', '2026-03-04', NULL, '2026-03-04', '2026-03-06', 1, 1, 1, 1, 0, 0, NULL, '2026-03-06 14:59:14'),
(29, 1, 1, 'Find a dentist. Make an appointment', NULL, 0, 0, '2026-03-05 14:03:50', '2026-03-05', '2026-03-05', NULL, '2026-03-05', NULL, 3, 0, 3, 5, 0, 0, NULL, '2026-03-05 14:03:50'),
(30, 1, 1, 'Add the ability to move tasks up and down in the todo list.', 1, 0, 0, '2026-03-06 15:06:34', '2026-03-06', '2026-03-06', NULL, '2026-03-06', NULL, 16, 0, 2, 3, 0, 0, NULL, '2026-03-20 13:13:01'),
(31, 1, 1, 'Prevent duplicate dependent tasks from occurring.', 1, 0, 0, '2026-03-06 15:12:10', '2026-04-04', '2026-04-04', NULL, '2026-04-04', NULL, 4, 0, 1, 8, 0, 0, NULL, '2026-04-18 11:38:56'),
(32, 1, 1, 'Do the laundry', NULL, 0, 0, '2026-03-07 13:31:35', '2026-03-09', '2026-03-07', NULL, '2026-03-10', NULL, 3, 0, 3, 6, 0, 0, NULL, '2026-03-10 12:13:09'),
(33, 1, 1, 'Change PG to Cat, short for category in Dashboard display task list', 1, 4, 0, '2026-03-07 13:35:11', '2026-03-11', '2026-03-10', NULL, '2026-03-11', '2026-03-10', 1, 0.25, 3, 6, 0, 0, NULL, '2026-03-10 12:12:50'),
...
(35, 1, 1, 'Rework the build and the code so that the GuiModels are not required.', 1, 4, 0, '2026-03-07 15:53:44', '2026-03-21', '2026-03-12', '2026-03-14', '2026-03-21', '2026-03-19', 3, 23, 1, 3, 0, 1, '41;', '2026-03-19 14:35:11'),
(36, 1, 1, 'Create a personal website using WordPress.', NULL, 0, 0, '2026-03-08 15:36:02', '2026-04-04', '2026-04-04', NULL, '2026-04-04', NULL, 32, 0, 1, 4, 0, 0, NULL, '2026-04-18 11:40:02'),
(37, 1, 1, 'Provide a method to sort the potential parent tasks in the select parent task dialog.', 1, 0, 0, '2026-03-09 13:10:12', '2026-03-09', '2026-03-09', NULL, '2026-03-09', NULL, 6, 0, 2, 1, 0, 0, NULL, '2026-03-20 13:12:28'),
(38, 1, 1, 'Change PG to Category in the dashboard task list.', 1, 4, 0, '2026-03-09 13:22:55', '2026-03-09', '2026-03-09', NULL, '2026-03-09', '2026-03-09', 1, 0, 2, 7, 0, 0, NULL, '2026-03-09 14:10:56'),
(39, 1, 1, 'Create an Organizational editor', 1, 0, 0, '2026-03-09 13:26:42', '2026-04-04', '2026-04-04', NULL, '2026-04-04', NULL, 24, 0, 1, 5, 0, 0, NULL, '2026-04-18 11:39:54'),
(40, 1, 1, 'Change the Date time editor field for a time edit field for schedule items start and end time', 1, 4, 0, '2026-03-10 12:30:20', '2026-03-10', '2026-03-10', '2026-03-11', '2026-03-10', '2026-03-12', 2, 8, 1, 2, 0, 0, NULL, '2026-03-12 13:45:28'),
(41, 1, 1, 'Change all pointers to model classes to database table IDs wherever possible', 35, 4, 0, '2026-03-18 14:48:27', '2026-03-18', '2026-03-18', '2026-03-18', '2026-03-18', '2026-03-19', 4, 8, 1, 10, 0, 0, NULL, '2026-03-19 14:36:58'),
(42, 1, 1, 'Testing the new push button interface for add task', NULL, 4, 0, '2026-03-20 15:12:37', '2026-03-20', '2026-03-20', '2026-03-20', '2026-03-20', '2026-03-20', 1, 0.25, 1, 1, 0, 0, NULL, '2026-03-20 15:12:55'),
(43, 1, 1, 'Remove dependencies on TaskModel from user dashboard', 1, 4, 0, '2026-03-21 14:25:17', '2026-03-21', '2026-03-21', '2026-03-21', '2026-03-21', '2026-03-21', 1, 1, 1, 1, 0, 0, NULL, '2026-03-21 14:25:37'),
(44, 1, 1, 'Show parent task name in task editor after it is selected.', 12, 4, 0, '2026-03-21 14:53:12', '2026-03-21', '2026-03-21', NULL, '2026-03-21', '2026-03-21', 2, 0.5, 1, 9, 0, 1, '45;', '2026-03-21 15:02:42'),
(45, 1, 1, 'Test add parent task display', 44, 4, 0, '2026-03-21 15:01:51', '2026-03-21', '2026-03-21', NULL, '2026-03-21', '2026-03-21', 1, 0.25, 1, 10, 0, 0, NULL, '2026-03-21 15:02:20'),
(46, 1, 1, 'Create a non-modal pop-up with similar contents for the user to select as the basis for a new schedule item', 1, 4, 0, '2026-03-22 13:34:38', '2026-03-22', '2026-03-22', '2026-03-29', '2026-03-22', '2026-04-05', 24, 40, 1, 3, 0, 0, NULL, '2026-04-05 15:07:09'),
(47, 1, 1, 'Rework integration testing to use real data as well as data from data files.', 1, 4, 0, '2026-03-22 16:15:59', '2026-03-22', '2026-03-22', '2026-03-22', '2026-03-22', '2026-03-24', 8, 8.7, 1, 2, 0, 0, NULL, '2026-03-24 14:22:09'),
(48, 1, 1, 'Test replacing QTextEdit with QPlainTextEdit everywhere in the code. A second time.', 1, 4, 0, '2026-03-27 15:41:30', '2026-03-27', '2026-03-27', NULL, '2026-03-27', '2026-03-27', 1, 0.25, 1, 1, 0, 0, NULL, '2026-03-27 15:42:14'),
(49, 1, 1, 'Allow users to delete schedule items, goals, notes and tasks,', 1, 3, 0, '2026-04-07 11:24:31', '2026-05-09', '2026-05-09', '2026-04-07', '2026-05-09', NULL, 80, 63, 1, 2, 0, 2, '50;51;', '2026-05-23 13:14:07'),
(50, 1, 1, 'Add stored procedure and functions to the database to implement all the current database functions using raw SQL.', 49, 4, 0, '2026-04-18 11:42:09', '2026-05-08', '2026-05-08', '2026-05-20', '2026-05-08', '2026-05-23', 80, 63, 1, 3, 0, 0, NULL, '2026-05-23 00:40:48'),
(51, 1, 1, 'Backup current planner database in preparation to move to new database architecture.', 49, 0, 0, '2026-05-23 13:14:07', '2026-05-23', '2026-05-23', NULL, '2026-05-23', NULL, 4, 0, 1, 3, 0, 0, NULL, '2026-05-23 13:14:07');
...
CREATE TABLE IF NOT EXISTS `UserGoals` (
  `idUserGoals` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `UserID` int(10) UNSIGNED NOT NULL,
  `Description` varchar(1024) NOT NULL,
  `Priority` int(11) DEFAULT NULL,
  `ParentGoal` int(10) UNSIGNED DEFAULT NULL,
  `CreationTS` datetime NOT NULL,
  `LastUpdateTS` datetime NOT NULL,
  PRIMARY KEY (`idUserGoals`,`UserID`),
  UNIQUE KEY `idUserGoals_UNIQUE` (`idUserGoals`),
  KEY `UG_Description_idx` (`Description`(768)),
  KEY `UG_CreationTS_idx` (`CreationTS` DESC),
  KEY `UG_LastUpdateTS_idx` (`LastUpdateTS` DESC),
  KEY `fk_UserGoals_UserID_idx` (`UserID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `UserNotes` (
  `idUserNotes` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `UserID` int(10) UNSIGNED NOT NULL,
  `NotationDateTime` datetime NOT NULL,
  `Content` varchar(1024) NOT NULL,
  `LastUpdate` datetime NOT NULL,
  PRIMARY KEY (`idUserNotes`,`UserID`),
  UNIQUE KEY `idUserNotes_UNIQUE` (`idUserNotes`),
  KEY `NotationDateTime` (`NotationDateTime` DESC),
  KEY `UserNotesLastUpdate` (`LastUpdate` DESC),
  KEY `UN_Content_idx` (`Content`(768)),
  KEY `fk_UserNotes_UserID_idx` (`UserID`)
...
CREATE TABLE IF NOT EXISTS `UserProfile` (
  ...
  UNIQUE KEY `UP_UserID_UNIQUE` (`UserID`),
  UNIQUE KEY `UP_LoginName_UNIQUE` (`LoginName`),
  UNIQUE KEY `UP_FullName_UNIQUE` (`LastName`,`FirstName`,`MiddleInitial`),
  UNIQUE KEY `UP_Email_UNIQUE` (`EmailAddress`),
  KEY `UP_LastLogin` (`LastLogin` DESC),
  KEY `fk_UserProfile_OrgID_idx` (`Organization_ID`)
...
(1, NULL, 'Chernick', 'Paul', 'A', 'paul.chernick@chernicksw.com', 'pacmaninbw', 'M1nus+1r3th', '8:30 AM;5:00 PM;1;1;1;0;', '2026-01-23 15:14:39', '2026-05-25 12:55:40'),
(3, NULL, 'Chernick', 'Paul2', 'B', 'pcfriends@chernicksw.com', 'ChernickPaulA', 'pacmaninbw', '8:30 AM;5:00 PM;1;1;1;0;', '2026-03-15 21:01:17', '2026-03-19 14:03:42'),
(4, NULL, 'Shiminotitz', 'Eitan', 'Y', 'EitanShiminotitz@google.com', 'ShiminotitzEitanY', 'ShiminotitzEitanY', '8:30 AM;5:00 PM;1;1;1;0;', '2026-03-19 13:51:42', '2026-03-19 13:51:42');

-- --------------------------------------------------------

--
-- Table structure for table `UserScheduleItem`
--

DROP TABLE IF EXISTS `UserScheduleItem`;
CREATE TABLE IF NOT EXISTS `UserScheduleItem` (
  `idUserScheduleItem` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `UserID` int(10) UNSIGNED NOT NULL,
  ...
  UNIQUE KEY `idUserScheduleItem_UNIQUE` (`idUserScheduleItem`),
  KEY `ScheduleItem_Title_idx` (`Title`),
  KEY `ScheduleItem_StartDateTime_idx` (`StartDateTime` DESC),
  KEY `ScheduleItem_CreatedTS_idx` (`CreatedTS` DESC),
  KEY `ScheduleItem_LastUpdateTS_idx` (`LastUpdateTS` DESC),
  KEY `fk_UserScheduleItem_UserID_idx` (`UserID`),
  KEY `ScheduleItem_Location_idx` (`Location`)
...
(353, 1, '2026-03-29 12:00:00', '2026-03-29 12:29:59', 'Read email, clear notifications on LinkedIn, plan day ', 1, 'Starbuck', '2026-03-29 12:16:20', '2026-03-29 12:16:20'),
...
(386, 1, '2026-04-02 11:00:00', '2026-04-02 11:14:59', 'Coffee at Starbucks say hello to everyone ', 1, 'Starbuccks', '2026-04-02 11:18:42', '2026-04-02 11:18:42'),
...
(425, 1, '2026-04-06 11:30:00', '2026-04-06 11:44:59', 'Code Review Moderator Oversight', 0, 'Starbuck', '2026-04-06 11:55:37', '2026-04-06 11:56:32'),
...
(448, 1, '2026-04-09 17:00:00', '2026-04-09 17:59:59', 'Clean grill pan', 1, 'H', '2026-04-09 12:20:20', '2026-04-09 12:20:20'),
...
(494, 1, '2026-04-15 11:15:00', '2026-04-15 11:29:59', 'Read email, clear notifications on LinkedIn, plan day ', 1, 'Stabucks', '2026-04-15 11:18:48', '2026-04-15 11:18:48'),
...
DROP TABLE IF EXISTS `UserTaskGoals`;
CREATE TABLE IF NOT EXISTS `UserTaskGoals` (
  ...
  KEY `UTG_Task_idx` (`TaskID`),
  KEY `UTG_CreationTS_idx` (`CreationTS` DESC),
  KEY `UTG_LastUpdateTS_idx` (`LastUpdateTS` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `Tasks`
  ADD CONSTRAINT `fk_Tasks_AsignedTo` FOREIGN KEY (`AsignedTo`) REFERENCES `UserProfile` (`UserID`),
  ADD CONSTRAINT `fk_Tasks_CreatedBy` FOREIGN KEY (`CreatedBy`) REFERENCES `UserProfile` (`UserID`);

--
-- Constraints for table `UserGoals`
--
ALTER TABLE `UserGoals`
  ADD CONSTRAINT `fk_UserGoals_UserID` FOREIGN KEY (`UserID`) REFERENCES `UserProfile` (`UserID`);

--
-- Constraints for table `UserNotes`
--
ALTER TABLE `UserNotes`
  ADD CONSTRAINT `fk_UserNotes_UserID` FOREIGN KEY (`UserID`) REFERENCES `UserProfile` (`UserID`);

--
-- Constraints for table `UserProfile`
--
ALTER TABLE `UserProfile`
  ADD CONSTRAINT `fk_UserProfile_OrgID` FOREIGN KEY (`Organization_ID`) REFERENCES `OrganizationProfile` (`OrganizationID`);

--
-- Constraints for table `UserScheduleItem`
--
ALTER TABLE `UserScheduleItem`
  ADD CONSTRAINT `fk_UserScheduleItem_UserID` FOREIGN KEY (`UserID`) REFERENCES `UserProfile` (`UserID`);

--
-- Constraints for table `UserTaskGoals`
--
ALTER TABLE `UserTaskGoals`
  ADD CONSTRAINT `fk_UserTaskGoals_AsignedTo` FOREIGN KEY (`UserID`) REFERENCES `UserProfile` (`UserID`),
  ADD CONSTRAINT `fk_UserTaskGoals_TaskID` FOREIGN KEY (`TaskID`) REFERENCES `Tasks` (`TaskID`);
COMMIT;
